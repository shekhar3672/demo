@extends('layouts.app', ['activePage' => 'contacts', 'titlePage' => __('Post Job')])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="POST" action="{{ route('savecontact') }}" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('primary_phone') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('primary_phone') ? ' is-invalid' : '' }}" name="primary_phone" id="primary_phone" type="number" placeholder="{{ __('primary phone') }}" value=""  aria-required="true"/>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('secondary_phone') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('secondary_phone') ? ' is-invalid' : '' }}" name="secondary_phone" id="secondary_phone" type="number" placeholder="{{ __('secondary phone') }}" value=""  aria-required="true"/>
