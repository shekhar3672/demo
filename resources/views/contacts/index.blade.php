@extends('layouts.app', ['activePage' => 'contacts', 'titlePage' => __('Contacts Management')])
        ...
        <div class="card">
          ...
          <div class="card-body">
              ...
              <div class="row">
                ...
                <form method="get" action="{{ route('contacts') }}" id="search-box_search_form_3" class="search-box_search_form d-flex flex-lg-row flex-column align-items-center justify-content-between ">
                @csrf
