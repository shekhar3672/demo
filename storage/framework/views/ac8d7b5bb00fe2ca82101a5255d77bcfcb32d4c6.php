<?php $__env->startSection('content'); ?>
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="POST" action="<?php echo e(route('savecontact')); ?>" enctype="multipart/form-data" autocomplete="off" class="form-horizontal">
            <?php echo csrf_field(); ?>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group<?php echo e($errors->has('primary_phone') ? ' has-danger' : ''); ?>">
                      <input class="form-control<?php echo e($errors->has('primary_phone') ? ' is-invalid' : ''); ?>" name="primary_phone" id="primary_phone" type="number" placeholder="<?php echo e(__('primary phone')); ?>" value=""  aria-required="true"/>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group<?php echo e($errors->has('secondary_phone') ? ' has-danger' : ''); ?>">
                      <input class="form-control<?php echo e($errors->has('secondary_phone') ? ' is-invalid' : ''); ?>" name="secondary_phone" id="secondary_phone" type="number" placeholder="<?php echo e(__('secondary phone')); ?>" value=""  aria-required="true"/>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'contacts', 'titlePage' => __('Post Job')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jobist\resources\views/contacts/create_contact.blade.php ENDPATH**/ ?>