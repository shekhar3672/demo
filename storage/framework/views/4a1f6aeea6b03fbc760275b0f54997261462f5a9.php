<?php $__env->startSection('content'); ?>
  <div class="content">
          ...
          <form method="post" action="<?php echo e(route('updatecontact')); ?>" autocomplete="off" class="form-horizontal">
            ...
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title"><?php echo e(__('Update Contact')); ?></h4>
               ...
               <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group<?php echo e($errors->has('first_name') ? ' has-danger' : ''); ?>">
                      <input class="form-control<?php echo e($errors->has('first_name') ? ' is-invalid' : ''); ?>" name="first_name" id="first_name" type="text" placeholder="<?php echo e(__('first name')); ?>"  value="<?php echo e($data['first_name']); ?>"  aria-required="true"/>
				...
				<div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group<?php echo e($errors->has('middle_name') ? ' has-danger' : ''); ?>">
                      <input class="form-control<?php echo e($errors->has('middle_name') ? ' is-invalid' : ''); ?>" name="middle_name" id="middle_name" type="text" placeholder="<?php echo e(__('middle name')); ?>"  value="<?php echo e($data['middle_name']); ?>"   aria-required="true"/>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group<?php echo e($errors->has('last_name') ? ' has-danger' : ''); ?>">
                      <input class="form-control<?php echo e($errors->has('last_name') ? ' is-invalid' : ''); ?>" name="last_name" id="last_name" type="text" placeholder="<?php echo e(__('last name')); ?>"  value="<?php echo e($data['last_name']); ?>"  aria-required="true"/>
				...
				<div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group<?php echo e($errors->has('primary_phone') ? ' has-danger' : ''); ?>">
                      <input class="form-control<?php echo e($errors->has('primary_phone') ? ' is-invalid' : ''); ?>" name="primary_phone" id="primary_phone" type="number" placeholder="<?php echo e(__('primary phone')); ?>"  value="<?php echo e($data['primary_phone']); ?>"  aria-required="true"/>
				...
				<div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group<?php echo e($errors->has('secondary_phone') ? ' has-danger' : ''); ?>">
                      <input class="form-control<?php echo e($errors->has('secondary_phone') ? ' is-invalid' : ''); ?>" name="secondary_phone" id="secondary_phone" type="number" placeholder="<?php echo e(__('secondary phone')); ?>" value="<?php echo e($data['secondary_phone']); ?>"  aria-required="true"/>
				...
				<div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group<?php echo e($errors->has('email') ? ' has-danger' : ''); ?>">
                      <input class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email" id="email" type="email" placeholder="<?php echo e(__('email')); ?>"   value="<?php echo e($data['email']); ?>"  aria-required="true"/>
    ...
    <div>
		...
		<?php if($errors->has('email')): ?>
                        <span id="image-error" class="error text-danger" for="image"><?php echo e($errors->first('image')); ?></span>
        <?php endif; ?>
    </div>
</div>
                  </div>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'contacts', 'titlePage' => __('Edit Job')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jobist\resources\views/contacts/edit_contact.blade.php ENDPATH**/ ?>